...
//   4. A run that still comes out 'easy' is upgraded to 'tempo' if its
...
// `splits` is optional (output of computeMileSplits); without it, a run is
// classified from its average pace alone.
function mapActivityToRun(activity, splits) {
